...
This example teaches **Basic Column Table** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\01_column_tables\01_basic_column_table`
...
```powershell
pytest examples/cms/01_column_tables/01_basic_column_table/test_basic_column_table.py -q
```
...
The README lives at `examples/cms/01_column_tables/01_basic_column_table/README.md`; the executable behavior lives next to it in the feature and test files.

## Previous / Next

Previous: [../../../users/05_outputs_and_api_styles/06_custom_build_output](../../../users/05_outputs_and_api_styles/06_custom_build_output)

Next: [../02_missing_optional_rows](../02_missing_optional_rows)
