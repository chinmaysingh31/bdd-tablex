# Duplicate Ids And Item Diagnostics

## Purpose

This example teaches **Duplicate Ids And Item Diagnostics** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\01_column_tables\03_duplicate_ids_and_item_diagnostics`
...
```powershell
pytest examples/cms/01_column_tables/03_duplicate_ids_and_item_diagnostics/test_duplicate_ids_and_item_diagnostics.py -q
```
...
The README lives at `examples/cms/01_column_tables/03_duplicate_ids_and_item_diagnostics/README.md`; the executable behavior lives next to it in the feature and test files.

## Previous / Next

Previous: [../02_missing_optional_rows](../02_missing_optional_rows)

Next: [../../02_variants/01_declarative_tablefields_variants](../../02_variants/01_declarative_tablefields_variants)
