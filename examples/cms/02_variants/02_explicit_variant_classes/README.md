...
This example teaches **Explicit Variant Classes** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\02_variants\02_explicit_variant_classes`
...
```powershell
pytest examples/cms/02_variants/02_explicit_variant_classes/test_explicit_variant_classes.py -q
```
...
The README lives at `examples/cms/02_variants/02_explicit_variant_classes/README.md`; the executable behavior lives next to it in the feature and test files.

## Previous / Next

Previous: [../01_declarative_tablefields_variants](../01_declarative_tablefields_variants)

Next: [../03_variant_specific_validation](../03_variant_specific_validation)
