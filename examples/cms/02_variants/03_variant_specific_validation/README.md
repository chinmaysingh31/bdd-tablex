...
This example teaches **Variant Specific Validation** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\02_variants\03_variant_specific_validation`
...
Previous: [../02_explicit_variant_classes](../02_explicit_variant_classes)

Next: [../04_variant_output_models](../04_variant_output_models)
