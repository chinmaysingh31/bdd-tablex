# Variant Output Models

## Purpose

This example teaches **Variant Output Models** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\02_variants\04_variant_output_models`
...
Previous: [../03_variant_specific_validation](../03_variant_specific_validation)

Next: [../05_inapplicable_field_policies](../05_inapplicable_field_policies)
