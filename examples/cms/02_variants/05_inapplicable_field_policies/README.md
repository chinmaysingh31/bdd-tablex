# Inapplicable Field Policies

## Purpose

This example teaches **Inapplicable Field Policies** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\02_variants\05_inapplicable_field_policies`
...
```powershell
pytest examples/cms/02_variants/05_inapplicable_field_policies/test_inapplicable_field_policies.py -q
```
...
The README lives at `examples/cms/02_variants/05_inapplicable_field_policies/README.md`; the executable behavior lives next to it in the feature and test files.

## Previous / Next

Previous: [../04_variant_output_models](../04_variant_output_models)

Next: [../../03_references_and_sources/01_single_reference](../../03_references_and_sources/01_single_reference)
