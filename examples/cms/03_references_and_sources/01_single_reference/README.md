...
This example teaches **Single Reference** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\03_references_and_sources\01_single_reference`
...
```powershell
pytest examples/cms/03_references_and_sources/01_single_reference/test_single_reference.py -q
```
...
The README lives at `examples/cms/03_references_and_sources/01_single_reference/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/cms/03_references_and_sources/01_single_reference/README.md`

## Previous / Next

Previous: [../../02_variants/05_inapplicable_field_policies](../../02_variants/05_inapplicable_field_policies)

Next: [../02_many_references](../02_many_references)
