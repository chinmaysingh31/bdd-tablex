...
This example teaches **Many References** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\03_references_and_sources\02_many_references`
...
```powershell
pytest examples/cms/03_references_and_sources/02_many_references/test_many_references.py -q
```
...
The README lives at `examples/cms/03_references_and_sources/02_many_references/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/cms/03_references_and_sources/02_many_references/README.md`

## Previous / Next

Previous: [../01_single_reference](../01_single_reference)

Next: [../03_typed_id_references](../03_typed_id_references)
