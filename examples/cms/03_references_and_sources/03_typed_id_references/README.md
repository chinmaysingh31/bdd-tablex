...
This example teaches **Typed Id References** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\03_references_and_sources\03_typed_id_references`
...
```powershell
pytest examples/cms/03_references_and_sources/03_typed_id_references/test_typed_id_references.py -q
```
...
The README lives at `examples/cms/03_references_and_sources/03_typed_id_references/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/cms/03_references_and_sources/03_typed_id_references/README.md`

## Previous / Next

Previous: [../02_many_references](../02_many_references)

Next: [../04_record_sources](../04_record_sources)
