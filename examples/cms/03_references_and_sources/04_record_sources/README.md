...
This example teaches **Record Sources** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\03_references_and_sources\04_record_sources`
...
The README lives at `examples/cms/03_references_and_sources/04_record_sources/README.md`; the executable behavior lives next to it in the feature and test files.

## Previous / Next

Previous: [../03_typed_id_references](../03_typed_id_references)

Next: [../05_transformed_source_metadata](../05_transformed_source_metadata)
