...
This example teaches **Transformed Source Metadata** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\03_references_and_sources\05_transformed_source_metadata`
...
Previous: [../04_record_sources](../04_record_sources)

Next: [../../04_cell_dsl/01_exact_tokens](../../04_cell_dsl/01_exact_tokens)
