...
This example teaches **Exact Tokens** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\04_cell_dsl\01_exact_tokens`
...
```powershell
pytest examples/cms/04_cell_dsl/01_exact_tokens/test_exact_tokens.py -q
```
...
The README lives at `examples/cms/04_cell_dsl/01_exact_tokens/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/cms/04_cell_dsl/01_exact_tokens/README.md`

## Previous / Next

Previous: [../../03_references_and_sources/05_transformed_source_metadata](../../03_references_and_sources/05_transformed_source_metadata)

Next: [../02_regex_patterns](../02_regex_patterns)
