...
This example teaches **Regex Patterns** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\04_cell_dsl\02_regex_patterns`
...
```powershell
pytest examples/cms/04_cell_dsl/02_regex_patterns/test_regex_patterns.py -q
```
...
The README lives at `examples/cms/04_cell_dsl/02_regex_patterns/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/cms/04_cell_dsl/02_regex_patterns/README.md`

## Previous / Next

Previous: [../01_exact_tokens](../01_exact_tokens)

Next: [../03_predicate_rules](../03_predicate_rules)
