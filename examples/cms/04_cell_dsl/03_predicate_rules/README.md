...
This example teaches **Predicate Rules** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\04_cell_dsl\03_predicate_rules`
...
```powershell
pytest examples/cms/04_cell_dsl/03_predicate_rules/test_predicate_rules.py -q
```
...
The README lives at `examples/cms/04_cell_dsl/03_predicate_rules/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/cms/04_cell_dsl/03_predicate_rules/README.md`

## Previous / Next

Previous: [../02_regex_patterns](../02_regex_patterns)

Next: [../04_fallbacks](../04_fallbacks)
