...
This example teaches **Fallbacks** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\04_cell_dsl\04_fallbacks`
...
```powershell
pytest examples/cms/04_cell_dsl/04_fallbacks/test_fallbacks.py -q
```
...
The README lives at `examples/cms/04_cell_dsl/04_fallbacks/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/cms/04_cell_dsl/04_fallbacks/README.md`

## Previous / Next

Previous: [../03_predicate_rules](../03_predicate_rules)

Next: [../05_field_scoped_rules](../05_field_scoped_rules)
