...
This example teaches **Dsl Error Diagnostics** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\04_cell_dsl\07_dsl_error_diagnostics`
...
```powershell
pytest examples/cms/04_cell_dsl/07_dsl_error_diagnostics/test_dsl_error_diagnostics.py -q
```
...
The README lives at `examples/cms/04_cell_dsl/07_dsl_error_diagnostics/README.md`; the executable behavior lives next to it in the feature and test files.

## Previous / Next

Previous: [../06_composed_dsls](../06_composed_dsls)

Next: [../../05_transformers/01_tabledata_and_tablecell](../../05_transformers/01_tabledata_and_tablecell)
