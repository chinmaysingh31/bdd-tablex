...
This example teaches **Tabledata And Tablecell** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\05_transformers\01_tabledata_and_tablecell`
...
```powershell
pytest examples/cms/05_transformers/01_tabledata_and_tablecell/test_tabledata_and_tablecell.py -q
```
...
The README lives at `examples/cms/05_transformers/01_tabledata_and_tablecell/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/cms/05_transformers/01_tabledata_and_tablecell/README.md`

## Previous / Next

Previous: [../../04_cell_dsl/07_dsl_error_diagnostics](../../04_cell_dsl/07_dsl_error_diagnostics)

Next: [../02_numeric_group_expansion](../02_numeric_group_expansion)
