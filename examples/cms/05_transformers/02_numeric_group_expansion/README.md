# Numeric Group Expansion

## Purpose

This example teaches **Numeric Group Expansion** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\05_transformers\02_numeric_group_expansion`
...
from bdd_tablex import ColumnGroupExpander, ColumnTable, NumericRange, PrefixRepeat, field, id_field
...
```powershell
pytest examples/cms/05_transformers/02_numeric_group_expansion/test_numeric_group_expansion.py -q
```
...
The README lives at `examples/cms/05_transformers/02_numeric_group_expansion/README.md`; the executable behavior lives next to it in the feature and test files.

## Previous / Next

Previous: [../01_tabledata_and_tablecell](../01_tabledata_and_tablecell)

Next: [../03_alphabetic_group_expansion](../03_alphabetic_group_expansion)
