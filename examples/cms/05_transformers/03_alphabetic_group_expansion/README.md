# Alphabetic Group Expansion

## Purpose

This example teaches **Alphabetic Group Expansion** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\05_transformers\03_alphabetic_group_expansion`
...
```powershell
pytest examples/cms/05_transformers/03_alphabetic_group_expansion/test_alphabetic_group_expansion.py -q
```
...
The README lives at `examples/cms/05_transformers/03_alphabetic_group_expansion/README.md`; the executable behavior lives next to it in the feature and test files.

## Previous / Next

Previous: [../02_numeric_group_expansion](../02_numeric_group_expansion)

Next: [../04_prefix_and_suffix_repeats](../04_prefix_and_suffix_repeats)
