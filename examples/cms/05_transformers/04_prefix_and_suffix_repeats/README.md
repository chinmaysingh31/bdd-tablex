# Prefix And Suffix Repeats

## Purpose

This example teaches **Prefix And Suffix Repeats** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\05_transformers\04_prefix_and_suffix_repeats`
...
```powershell
pytest examples/cms/05_transformers/04_prefix_and_suffix_repeats/test_prefix_and_suffix_repeats.py -q
```
...
The README lives at `examples/cms/05_transformers/04_prefix_and_suffix_repeats/README.md`; the executable behavior lives next to it in the feature and test files.

## Previous / Next

Previous: [../03_alphabetic_group_expansion](../03_alphabetic_group_expansion)

Next: [../05_custom_range_repeat_rules](../05_custom_range_repeat_rules)
