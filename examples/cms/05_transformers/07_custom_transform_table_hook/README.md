# Custom Transform Table Hook

## Purpose

This example teaches **Custom Transform Table Hook** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\05_transformers\07_custom_transform_table_hook`
...
```powershell
pytest examples/cms/05_transformers/07_custom_transform_table_hook/test_custom_transform_table_hook.py -q
```
...
The README lives at `examples/cms/05_transformers/07_custom_transform_table_hook/README.md`; the executable behavior lives next to it in the feature and test files.

## Previous / Next

Previous: [../06_transformer_pipeline](../06_transformer_pipeline)

Next: [../../06_tooling/01_schema_introspection](../../06_tooling/01_schema_introspection)
