# Static Checker Python Api

## Purpose

This example teaches **Static Checker Python Api** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\06_tooling\02_static_checker_python_api`
...
```powershell
pytest examples/cms/06_tooling/02_static_checker_python_api/test_static_checker_python_api.py -q
```
...
The README lives at `examples/cms/06_tooling/02_static_checker_python_api/README.md`; the executable behavior lives next to it in the feature and test files.

## Previous / Next

Previous: [../01_schema_introspection](../01_schema_introspection)

Next: [../03_cli_describe](../03_cli_describe)
