...
This example teaches **Cli Describe** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\cms\06_tooling\03_cli_describe`
...
```powershell
pytest examples/cms/06_tooling/03_cli_describe/test_cli_describe.py -q
```
...
The README lives at `examples/cms/06_tooling/03_cli_describe/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/cms/06_tooling/03_cli_describe/README.md`

## Previous / Next

Previous: [../02_static_checker_python_api](../02_static_checker_python_api)

Next: [../04_cli_check_json](../04_cli_check_json)
