...
This example teaches **Basic Required Fields** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\users\01_row_tables\01_basic_required_fields`
...
```powershell
pytest examples/users/01_row_tables/01_basic_required_fields/test_basic_required_fields.py -q
```
...
The README lives at `examples/users/01_row_tables/01_basic_required_fields/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/users/01_row_tables/01_basic_required_fields/README.md`

## Previous / Next

Previous: [../../../README.md](../../../README.md)

Next: [../02_optional_fields_and_defaults](../02_optional_fields_and_defaults)
