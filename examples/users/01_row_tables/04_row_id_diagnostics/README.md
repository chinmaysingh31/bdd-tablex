...
This example teaches **Row Id Diagnostics** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\users\01_row_tables\04_row_id_diagnostics`
...
```powershell
pytest examples/users/01_row_tables/04_row_id_diagnostics/test_row_id_diagnostics.py -q
```
...
The README lives at `examples/users/01_row_tables/04_row_id_diagnostics/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/users/01_row_tables/04_row_id_diagnostics/README.md`

## Previous / Next

Previous: [../03_row_id_field_context](../03_row_id_field_context)

Next: [../../02_parsers/01_scalar_parsers](../../02_parsers/01_scalar_parsers)
