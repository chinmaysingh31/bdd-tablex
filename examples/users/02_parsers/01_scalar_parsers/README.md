...
This example teaches **Scalar Parsers** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\users\02_parsers\01_scalar_parsers`
...
```powershell
pytest examples/users/02_parsers/01_scalar_parsers/test_scalar_parsers.py -q
```
...
The README lives at `examples/users/02_parsers/01_scalar_parsers/README.md`; the executable behavior lives next to it in the feature and test files.

## Previous / Next

Previous: [../../01_row_tables/04_row_id_diagnostics](../../01_row_tables/04_row_id_diagnostics)

Next: [../02_boolean_custom_vocabulary](../02_boolean_custom_vocabulary)
