...
This example teaches **Aliases** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\users\03_schema_evolution\01_aliases`
...
```powershell
pytest examples/users/03_schema_evolution/01_aliases/test_aliases.py -q
```
...
The README lives at `examples/users/03_schema_evolution/01_aliases/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/users/03_schema_evolution/01_aliases/README.md`
...
Previous: [../../02_parsers/07_empty_cell_policies](../../02_parsers/07_empty_cell_policies)

Next: [../02_unknown_fields_ignore](../02_unknown_fields_ignore)
