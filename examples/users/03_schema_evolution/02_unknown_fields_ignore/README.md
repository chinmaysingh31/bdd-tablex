...
This example teaches **Unknown Fields Ignore** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\users\03_schema_evolution\02_unknown_fields_ignore`
...
```powershell
pytest examples/users/03_schema_evolution/02_unknown_fields_ignore/test_unknown_fields_ignore.py -q
```
...
The README lives at `examples/users/03_schema_evolution/02_unknown_fields_ignore/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/users/03_schema_evolution/02_unknown_fields_ignore/README.md`

## Previous / Next

Previous: [../01_aliases](../01_aliases)

Next: [../03_unknown_fields_preserve](../03_unknown_fields_preserve)
