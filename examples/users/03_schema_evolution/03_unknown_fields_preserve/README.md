...
This example teaches **Unknown Fields Preserve** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\users\03_schema_evolution\03_unknown_fields_preserve`
...
```powershell
pytest examples/users/03_schema_evolution/03_unknown_fields_preserve/test_unknown_fields_preserve.py -q
```
...
The README lives at `examples/users/03_schema_evolution/03_unknown_fields_preserve/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/users/03_schema_evolution/03_unknown_fields_preserve/README.md`

## Previous / Next

Previous: [../02_unknown_fields_ignore](../02_unknown_fields_ignore)

Next: [../../04_validation_and_errors/01_record_validation](../../04_validation_and_errors/01_record_validation)
