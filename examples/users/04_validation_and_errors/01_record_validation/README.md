...
This example teaches **Record Validation** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\users\04_validation_and_errors\01_record_validation`
...
Feature: User focused example
  ...
  Scenario: Demonstrate Record Validation
...
The README lives at `examples/users/04_validation_and_errors/01_record_validation/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/users/04_validation_and_errors/01_record_validation/README.md`

## Previous / Next

Previous: [../../03_schema_evolution/03_unknown_fields_preserve](../../03_schema_evolution/03_unknown_fields_preserve)

Next: [../02_table_validation](../02_table_validation)
