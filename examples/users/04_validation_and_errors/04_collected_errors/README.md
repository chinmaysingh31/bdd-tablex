...
This example teaches **Collected Errors** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\users\04_validation_and_errors\04_collected_errors`
...
Feature: User focused example
  ...
  Scenario: Demonstrate Collected Errors
...
```powershell
pytest examples/users/04_validation_and_errors/04_collected_errors/test_collected_errors.py -q
```
...
The README lives at `examples/users/04_validation_and_errors/04_collected_errors/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/users/04_validation_and_errors/04_collected_errors/README.md`

## Previous / Next

Previous: [../03_source_aware_errors](../03_source_aware_errors)

Next: [../../05_outputs_and_api_styles/01_parse_vs_parse_records](../../05_outputs_and_api_styles/01_parse_vs_parse_records)
