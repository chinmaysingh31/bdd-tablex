# Parse Vs Parse Records

## Purpose

This example teaches **Parse Vs Parse Records** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\users\05_outputs_and_api_styles\01_parse_vs_parse_records`
...
Feature: User focused example
  ...
  Scenario: Demonstrate Parse vs Parse Records
...
```powershell
pytest examples/users/05_outputs_and_api_styles/01_parse_vs_parse_records/test_parse_vs_parse_records.py -q
```
...
The README lives at `examples/users/05_outputs_and_api_styles/01_parse_vs_parse_records/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/users/05_outputs_and_api_styles/01_parse_vs_parse_records/README.md`

## Previous / Next

Previous: [../../04_validation_and_errors/04_collected_errors](../../04_validation_and_errors/04_collected_errors)

Next: [../02_functional_api](../02_functional_api)
