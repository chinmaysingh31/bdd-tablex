...
This example teaches **Functional Api** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\users\05_outputs_and_api_styles\02_functional_api`
...
Feature: User focused example
  ...
  Scenario: Demonstrate Functional API
...
```powershell
pytest examples/users/05_outputs_and_api_styles/02_functional_api/test_users_functional_api_example.py -q
```
...
The README lives at `examples/users/05_outputs_and_api_styles/02_functional_api/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/users/05_outputs_and_api_styles/02_functional_api/README.md`
...
Previous: [../01_parse_vs_parse_records](../01_parse_vs_parse_records)

Next: [../03_pytest_fixture](../03_pytest_fixture)
