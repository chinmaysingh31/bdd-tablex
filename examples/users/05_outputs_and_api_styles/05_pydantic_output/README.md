...
This example teaches **Pydantic Output** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\users\05_outputs_and_api_styles\05_pydantic_output`
...
Feature: User focused example
  ...
  Scenario: Demonstrate Pydantic Output
...
The README lives at `examples/users/05_outputs_and_api_styles/05_pydantic_output/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/users/05_outputs_and_api_styles/05_pydantic_output/README.md`

## Previous / Next

Previous: [../04_dataclass_output](../04_dataclass_output)

Next: [../06_custom_build_output](../06_custom_build_output)
