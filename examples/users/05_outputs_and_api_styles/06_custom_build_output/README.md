...
This example teaches **Custom Build Output** in isolation so the learner can see one bdd-tablex behavior without unrelated machinery competing for attention.
...
Path: `.\examples\users\05_outputs_and_api_styles\06_custom_build_output`
...
Feature: User focused example
  ...
  Scenario: Demonstrate Custom Build Output
...
```powershell
pytest examples/users/05_outputs_and_api_styles/06_custom_build_output/test_custom_build_output.py -q
```
...
The README lives at `examples/users/05_outputs_and_api_styles/06_custom_build_output/README.md`; the executable behavior lives next to it in the feature and test files.
...
Source: `examples/users/05_outputs_and_api_styles/06_custom_build_output/README.md`

## Previous / Next

Previous: [../05_pydantic_output](../05_pydantic_output)

Next: [../../../cms/01_column_tables/01_basic_column_table](../../../cms/01_column_tables/01_basic_column_table)
